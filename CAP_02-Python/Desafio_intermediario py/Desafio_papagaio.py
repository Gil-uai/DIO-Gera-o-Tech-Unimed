...
while True:
    ...
    try: 
      ...
      perna = input() # vai receber a entrada para teste

      if perna == "esquerda": # este bloco faz a comparação do status das pernas
        print("ingles")
      ...
      else: # se nenhuma das situações acima sai do loop
        break
